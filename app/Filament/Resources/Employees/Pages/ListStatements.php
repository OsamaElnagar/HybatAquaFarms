...
class ListStatements extends Page implements HasTable
{
    ...
    protected string $view = 'filament.resources.employees.pages.list-statements';

    protected static ?string $title = 'سجل كشوفات حساب الموظف';
        ...
        return $table
            ...
            ->actions([
                Action::make('viewStatement')
                    ->label('عرض الكشف')
                    ->icon('heroicon-o-eye')
                    ->url(fn (EmployeeStatement $record) => EmployeeResource::getUrl('statement', [
