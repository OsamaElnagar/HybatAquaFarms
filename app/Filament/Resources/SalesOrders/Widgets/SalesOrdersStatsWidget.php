...
class SalesOrdersStatsWidget extends StatsOverviewWidget
{
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('إجمالي الإيرادات', number_format($totalRevenue).' EGP ')
                ->description('مبيعات هذا الشهر: '.number_format($thisMonthRevenue).' EGP ')
                ->descriptionIcon('heroicon-o-banknotes')
                ->color('success'),

            Stat::make('المستحقات', number_format($pendingValue).' EGP ')
