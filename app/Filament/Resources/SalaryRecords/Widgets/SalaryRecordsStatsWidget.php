...
class SalaryRecordsStatsWidget extends StatsOverviewWidget
{
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('إجمالي صافي المرتبات', number_format($totalNet).' EGP ')
                ->description('مجمل ما تم صرفه من مرتبات')
                ->descriptionIcon('heroicon-o-banknotes')
                ->color('primary'),

            Stat::make('صافي هذا الشهر', number_format($currentMonthNet).' EGP ')
            ...
            Stat::make('متوسط الصافي', number_format($averageNet).' EGP ')
